package ${package}.${artifactId}.config.security;

import cn.hutool.core.util.URLUtil;
import ${package}.${artifactId}.common.constants.BizConstant;
import ${package}.${artifactId}.common.constants.RedisCacheKey;
import ${package}.${artifactId}.common.enums.YesNoEnum;
import ${package}.${artifactId}.common.exception.UserAccessDeniedHandler;
import ${package}.${artifactId}.common.exception.UserAuthenticationEntryPoint;
import ${package}.${artifactId}.common.utils.redis.RedisService;
import ${package}.${artifactId}.config.security.component.AuthenticationJwtTokenFilter;
import ${package}.${artifactId}.config.security.component.ResourcePathFilter;
import ${package}.${artifactId}.config.security.component.SecurityProperties;
import ${package}.${artifactId}.config.security.component.SecurityUserDetailsService;
import ${package}.${artifactId}.config.security.component.Sm4PasswordEncoder;
