...
import ${package}.${artifactId}.common.model.result.ApiResult;
...
import ${package}.${artifactId}.model.vo.request.UserLoginRequest;
import ${package}.${artifactId}.model.vo.request.UserRegisterRequest;
import ${package}.${artifactId}.model.vo.response.CurrentUserResponse;
