...
import ${package}.${artifactId}.common.model.result.PageResultRecord;
import ${package}.${artifactId}.model.po.PermissionPO;
import ${package}.${artifactId}.model.po.RolePO;
import ${package}.${artifactId}.model.vo.request.RoleAddRequest;
import ${package}.${artifactId}.model.vo.request.RolePageRequest;
import ${package}.${artifactId}.service.IRoleService;
