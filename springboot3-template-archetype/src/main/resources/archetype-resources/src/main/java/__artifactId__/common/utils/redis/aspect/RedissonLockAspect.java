...
import ${package}.${artifactId}.common.utils.redis.RedisLockService;
import ${package}.${artifactId}.common.utils.redis.annotation.RedissonLock;
...
public class RedissonLockAspect {
    ...
    @Pointcut("@annotation(${package}.${artifactId}.common.utils.redis.annotation.RedissonLock)")
