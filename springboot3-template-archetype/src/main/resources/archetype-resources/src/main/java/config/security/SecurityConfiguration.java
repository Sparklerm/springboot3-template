...
import ${groupId}.common.exception.UserAccessDeniedHandler;
import ${groupId}.common.exception.UserAuthenticationEntryPoint;
import ${groupId}.common.utils.redis.RedisService;
import ${groupId}.config.security.component.AuthenticationJwtTokenFilter;
import ${groupId}.config.security.component.ResourcePathFilter;
import ${groupId}.config.security.component.SecurityProperties;
import ${groupId}.config.security.component.SecurityUserDetailsService;
import ${groupId}.config.security.component.Sm4PasswordEncoder;
